...
namespace ch {
    ...
    template<int dims> void integrate_fft(cufftFieldComplex *rho_hat, cufftComplex *f_der_hat, float *sqr_wave_vectors, float *dealiaser, float dt, float M, float k_laplacian);
}
